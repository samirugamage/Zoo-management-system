...
function AddFoodBought (){

 //add toastify message
 const notify = () => toast("Successfully food bought record added");
 const notify2 = () => toast("Error");
    ...
    const [foodsBoughtKg,setHeight] = useState("");
    ...
    async function updateRemainingWeight(fid,additionalWeight) {
        try {
          const response = await axios.put(`http://localhost:8070/food/updatebought/${fid}`, {
            additionalWeight
          });
      ...
      async function sendData(e) {
        ...
        try {
          ...
          const response = await axios.post("http://localhost:8070/foodbought/add", newFoodBought);
          console.log(response.data);
          notify();
      
          // Update the remaining weight
          await updateRemainingWeight(fid, parseFloat(foodsBoughtKg));
      ...
      <div  >
       ...
       <div>
               ...
               <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                 ...
                 <li class="nav-item ">
                   ...
                   <li class="nav-item ">
                     <a class="nav-link" href="/addfoodbought">Add an FoodBought record </a>
                   </li>
       ...
       {/* //----------------------------------------------------------------------------------------------Top Navigation End-------------------------------------------------- */}
        ...
        <br></br>
            ...
            <label for="inputHeight">Food Bought weight</label>
            ...
            />
             ...
             <button onSubmit={sendData} type="submit" className="btn btn-primary">Add an food Bought record</button>
